function visualizeTensor(dataCell)
    % VISUALIZETENSOR Interactive viewer for 3D spatial-temporal tensors
    ...
    function keyPressCallback(~, event)
        ...
        elseif strcmpi(key, 'home')
            state.current_frame = 1;
        % Jump to End
        elseif strcmpi(key, 'end')
            state.current_frame = num_frames;
        % Close Figure
